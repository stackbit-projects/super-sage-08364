...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5ff08364f5bfbc0015387a6c
...
To start editing your site, you can use the Sanity interface at https://super-sage-08364.sanity.studio/.
...
Generated at `2021-01-02T14:31:02.371Z` by Stackbit version `0.3.42`.